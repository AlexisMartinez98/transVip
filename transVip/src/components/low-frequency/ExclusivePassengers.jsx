...
export function ExclusivePassengers({
  passengers,
  onAssignVehicle
}) {
  return (
    <div className="space-y-4">
      {passengers.map((passenger) => (
        <div
          key={passenger.id}
          className="bg-white dark:bg-gray-800 rounded-xl p-4 shadow-sm dark:shadow-gray-900/50 flex items-center justify-between gap-4"
        >
